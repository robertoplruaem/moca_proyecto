...
# Rutas dinámicas
DIR_FUENTES = str(PROJECT_ROOT / "data" / "resources" / "fuentes")
DIR_PLANTILLAS = str(PROJECT_ROOT / "data" / "resources" / "plantillas")
...
if __name__ == '__main__':
    ...
    generar_dataset(30000, num_workers=4)